...
////            _fetchedResultsController = NSFetchedResultsController(fetchRequest: MessageDao.fetchRequestForMessagesWithInboxType(mailboxType), managedObjectContext: CoreDataUtility.mainManagedContext, sectionNameKeyPath: nil, cacheName: nil)
////        }
