...
class MailboxMessagesObserver: NSObject, NSFetchedResultsControllerDelegate {
    ...
    var fetchedResultsController: NSFetchedResultsController<NSFetchRequestResult> {
        if _fetchedResultsController == nil {
            _fetchedResultsController = NSFetchedResultsController(fetchRequest: MessageDao.fetchRequestForMessagesWithInboxType(mailboxType), managedObjectContext: PersistenceManager.mainManagedContext, sectionNameKeyPath: nil, cacheName: nil)
        }
