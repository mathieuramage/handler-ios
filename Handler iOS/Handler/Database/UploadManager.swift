...
class UploadManager: NSObject, NSURLSessionDelegate, NSURLSessionDataDelegate {
	...
	var uploadAction: HRUploadAction
	
	init(action: HRUploadAction, progressHandler: ((bytesSent: Int64, totalBytesSent: Int64, totalBytesExpectedToSend: Int64)->Void)? = nil, callback: ((success: Bool, error: HRError?)->Void)) throws {
		uploadAction = action
